...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'search','method' => 'GET','action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('articles.index'))]); ?>
    <?php if(Session::get('locale') == 'en'): ?>
        <?php if (isset($component)) { $__componentOriginal690b64017277cbdd89bc2d788db21f28 = $component; } ?>
<?php $component = ProtoneMedia\Splade\Components\Form\Input::resolve(['name' => 'search'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'input','placeholder' => 'Search articles']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'input','placeholder' => 'أبحث عن مقال']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal690b64017277cbdd89bc2d788db21f28)): ?>
<?php $component = $__componentOriginal690b64017277cbdd89bc2d788db21f28; ?>
...
<?php $component->withAttributes(['class' => 'submit']); ?>
        <?php echo app('translator')->get('buttons.search'); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/ywyh/coding/github/perfecthealth/resources/views/components/partials/search.blade.php ENDPATH**/ ?>