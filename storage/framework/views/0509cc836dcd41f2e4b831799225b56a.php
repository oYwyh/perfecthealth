...
<?php $component->withAttributes(['class' => 'bg']); ?>
        <div class="title"><?php echo app('translator')->get('titles.translated'); ?> <?php echo app('translator')->get('titles.article'); ?> <?php echo app('translator')->get('titles.version'); ?></div>
        <?php if($prevRoute == 'admin.manage.articles.add'): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(Route('admin.manage.articles.create')).'','method' => 'POST','id' => 'form','autocomplete' => 'off']); ?>
                <?php if (isset($component)) { $__componentOriginal690b64017277cbdd89bc2d788db21f28 = $component; } ?>
<?php $component = ProtoneMedia\Splade\Components\Form\Input::resolve(['type' => 'hidden','name' => 'lang'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="group">
                    <div class="form-column">
                        <label for="name"><?php echo app('translator')->get('titles.article'); ?> <?php echo app('translator')->get('labels.content'); ?></label>
                        <?php if (isset($component)) { $__componentOriginalb5cc7c86fac70ea4668b5307fcb3e962 = $component; } ?>
<?php $component = ProtoneMedia\Splade\Components\Form\Wysiwyg::resolve(['name' => 'content'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('splade-wysiwyg'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(ProtoneMedia\Splade\Components\Form\Wysiwyg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(Route('admin.manage.articles.update')).'','method' => 'POST','id' => 'form','autocomplete' => 'off']); ?>
                <?php if (isset($component)) { $__componentOriginal690b64017277cbdd89bc2d788db21f28 = $component; } ?>
<?php $component = ProtoneMedia\Splade\Components\Form\Input::resolve(['type' => 'hidden','name' => 'lang'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('splade-input'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH /home/ywyh/coding/github/perfecthealth/resources/views/dashboard/admin/manage/articles/translator.blade.php ENDPATH**/ ?>