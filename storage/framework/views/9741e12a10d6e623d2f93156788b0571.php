...
<?php $component->withAttributes(['class' => 'bg']); ?>
        <div class="title"><?php echo app('translator')->get('titles.create'); ?> <?php echo app('translator')->get('titles.article'); ?></div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(Route('admin.manage.articles.translate')).'','method' => 'POST','id' => 'form','autocomplete' => 'off']); ?>
                <div class="group">
...
<?php $component = ProtoneMedia\Splade\Components\Form\File::resolve(['preview' => true,'filepond' => true,'name' => 'image'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH /home/ywyh/coding/github/perfecthealth/resources/views/dashboard/admin/manage/articles/add.blade.php ENDPATH**/ ?>