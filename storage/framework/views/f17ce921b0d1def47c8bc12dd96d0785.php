...
<?php $component->withAttributes(['class' => 'bg']); ?>
        <div class="title"><?php echo app('translator')->get('titles.manage'); ?> <?php echo app('translator')->get('titles.newsletter'); ?></div>
        <div class="wrapper" style="">
            <?php if (isset($component)) { $__componentOriginal9e290f7144d9abd075e5cf038a814133 = $component; } ?>
<?php $component = ProtoneMedia\Splade\Components\Table::resolve(['for' => $newsletter] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php $__env->slot('spladeTableCell418c5509e2171d55b0aee5c2ea4442b5', function ($newsletter) use ($__env) { ?>
                    <Link href="<?php echo e(route('admin.manage.newsletter.remove',['id'=>$newsletter->id])); ?>" method="POST" class="text-red-500"><?php echo app('translator')->get('buttons.remove'); ?></Link>
                <?php }); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH /home/ywyh/coding/github/perfecthealth/resources/views/dashboard/admin/manage/newsletter/index.blade.php ENDPATH**/ ?>