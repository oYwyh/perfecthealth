...
import { size, attr, error, $$, css, call, toArray, getScrollParent } from "../helpers/index.js";
...
import { isMarker, isFunction, isString } from "../helpers/checker/index.js";
...
export class Selection {
        ...
        this.j.history.snapshot.transaction(() => {
            ...
            if (sel && sel.rangeCount) {
                ...
                if (Dom.isOrContains(this.area, range.commonAncestorContainer)) {
                    if (Dom.isTag(range.startContainer, INSEPARABLE_TAGS) &&
                        range.collapsed) {
    ...
    *wrapInTagGen(fakes) {
    ...
    expandSelection() {
        ...
        if (leftBox !== rightBox) {
            const rightInsideLeft = Dom.isElement(leftBox) &&
                Dom.isOrContains(leftBox, rightFake), leftInsideRight = !rightInsideLeft &&
