...
import { isArray, isFunction, isHTML, isString, isVoid, isSet, isMarker } from "../helpers/checker/index.js";
import { toArray } from "../helpers/array/index.js";
import { trim } from "../helpers/string/index.js";
import { $$, attr, call, css, dataBind, error } from "../helpers/utils/index.js";
import { LIST_TAGS, NO_EMPTY_TAGS, TEMP_ATTR } from "../constants.js";
/**
...
export class Dom {
    ...
    static findNotEmptyNeighbor(node, left, root) {
        return call(left ? Dom.prev : Dom.next, node, n => Boolean(n && (!Dom.isText(n) || trim(n?.nodeValue || '').length)), root);
    }
