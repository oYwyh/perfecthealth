...
import { isArray, isBoolean, isFunction, isString, isVoid, hasContainer } from "../../core/helpers/checker/index.js";
...
import { component, autobind, hook } from "../../core/decorators/index.js";
 ...
 */
export let Dialog = class Dialog extends ViewWithToolbar {
    /** @override */
    className() {
        return 'Dialog';
    }
    ...
    constructor(options = {}) {
        ...
        this.isOpened = false;
        const self = this;
        self.options = ConfigProto(options, ConfigProto(Config.prototype.dialog, View.defaultOptions));
