...
async function u(t, e = {}) {
  ...
  if (500 === m2)
    throw this.hooks.call("fetch:error", n2, { status: m2, response: u2, url: w2 }), new c(`Server error: ${w2}`, { status: m2, url: w2 });
  if (!g2)
    throw new c(`Empty response: ${w2}`, { status: m2, url: w2 });
