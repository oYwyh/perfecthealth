<x-frontend.layout>
    <div class="landing">
        <div class="wrapper">
            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper" id="swiper_landing">
                <div class="parallax-bg" data-swiper-parallax="-23%"></div>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="start">
                                <div class="texts">
                                    <div class="title" data-swiper-parallax="-300">@lang('frontpage.landingTitleOne')</div>
                                    <div class="text" data-swiper-parallax="-100">
                                        <p>
                                            @lang('frontpage.landingDescriptionOne')
                                        </p>
                                    </div>
                                </div>
                                <div class="buttons">
                                    <button class="contact"><span>@lang('frontpage.landingBtnOne')</span></button>
                                    <button class="learn"><span>@lang('frontpage.landingBtnTwo')</span></button>
                                </div>
                            </div>
                            <div class="end">
                        ...
                        <div class="swiper-slide">
                            <div class="start">
                                <div class="texts">
                                    <div class="title" data-swiper-parallax="-300">@lang('frontpage.landingTitleTwo')</div>
                                    <div class="text" data-swiper-parallax="-100">
                                        <p>
                                            @lang('frontpage.landingDescriptionTwo')
                                        </p>
                                    </div>
                                </div>
                                <div class="buttons">
    ...
    <div class="about">
        <div class="wrapper">
            ...
            <div class="end">
                <div class="title">
                    @lang('frontpage.aboutTitle')
                </div>
                <div class="description">
                    @lang('frontpage.aboutDescription')
                </div>
                <ul class="checks">
                    <li>
                        <div class="icon">
                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"  width="96.000000pt" height="96.000000pt" viewBox="0 0 96.000000 96.000000"  preserveAspectRatio="xMidYMid meet">  <g transform="translate(0.000000,96.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"> <path d="M347 840 c-26 -9 -53 -22 -59 -28 -7 -7 -18 -12 -24 -12 -16 0 -124 -108 -124 -124 0 -6 -5 -17 -11 -23 -23 -23 -48 -119 -48 -183 0 -64 25 -160 48 -183 6 -6 11 -17 11 -23 0 -16 108 -124 124 -124 6 0 17 -5 24 -12 20 -20 125 -48 182 -48 57 0 162 28 182 48 7 7 18 12 24 12 16 0 124 108 124 124 0 6 5 17 12 24 20 20 48 125 48 182 0 79 -8 102 -34 98 -19 -3 -22 -11 -27 -88 -13 -176 -78 -265 -237 -324 -130 -48 -307 22 -375 149 -34 62 -47 109 -47 165 0 107 69 231 155 278 130 71 246 68 364 -10 41 -27 44 -28 57 -11 21 28 17 36 -32 66 -113 68 -232 85 -337 47z"/> <path d="M641 566 c-86 -86 -163 -156 -170 -156 -8 0 -38 23 -68 51 -54 51 -85 60 -91 26 -4 -21 133 -167 158 -167 25 0 373 355 368 376 -9 46 -40 25 -197 -130z"/> </g> </svg>
                        </div>
                        <div class="txt">
                            @lang('frontpage.aboutCheckOne')
                        </div>
                    </li>
                    <li>
                        <div class="icon">
                    ...
                    <li>
                        ...
                        <div class="txt">
                            @lang('frontpage.aboutCheckThree')
                        </div>
                    </li>
                </ul>
                <div class="more">
                    <Link class="btn" href="{{Route('info.index')}}">
                        @lang('frontpage.aboutBtn')
                    </Link>
                </div>
            </div>
        </div>
    ...
    <div class="services">
        <div class="main-title">
            ...
            <div class="icons">
                ...
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"  width="50.000000pt" height="50.000000pt" viewBox="0 0 50.000000 50.000000"  preserveAspectRatio="xMidYMid meet">  <g transform="translate(0.000000,50.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"> <path d="M265 472 c-55 -22 -75 -36 -97 -67 -33 -48 -34 -66 -8 -122 10 -24 15 -43 10 -43 -6 0 -10 -22 -10 -50 l0 -50 85 0 85 0 0 55 c0 30 4 55 10 55 15 0 80 61 80 74 0 7 11 35 25 62 29 56 27 67 -12 88 -54 28 -94 27 -168 -2z m135 -8 c22 -9 40 -19 40 -23 0 -23 -53 -129 -72 -144 -60 -47 -131 -88 -144 -83 -26 10 -15 46 20 67 19 11 46 35 60 53 l25 34 -42 4 c-34 4 -47 0 -65 -18 -16 -16 -22 -29 -17 -43 6 -21 -8 -60 -17 -45 -3 5 -11 26 -17 46 -11 33 -10 41 12 74 18 29 39 44 88 65 78 33 79 33 129 13z m-135 -141 c-19 -17 -31 -21 -38 -14 -15 15 23 49 47 43 18 -5 17 -7 -9 -29z m-34 -133 c9 0 24 7 35 15 30 23 44 18 44 -15 l0 -30 -65 0 -65 0 0 32 c0 29 1 30 18 15 10 -10 25 -17 33 -17z"/> <path d="M63 124 c-18 -8 -33 -19 -33 -24 0 -14 16 -12 51 6 28 14 35 14 95 -6 35 -12 64 -26 64 -31 0 -12 0 -12 -48 5 -25 9 -44 11 -47 5 -4 -5 0 -11 7 -13 7 -2 29 -9 48 -16 30 -9 37 -8 50 8 8 10 29 23 45 29 17 6 38 14 48 18 10 4 17 3 17 -4 0 -6 -32 -27 -72 -47 l-72 -36 -62 22 c-61 21 -64 21 -93 4 -17 -10 -31 -22 -31 -26 0 -12 23 -9 43 6 15 11 27 11 82 -6 l64 -20 78 40 c56 28 79 46 81 61 5 31 -18 35 -74 13 l-49 -20 -64 24 c-72 27 -83 28 -128 8z"/> </g> </svg>
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"  width="50.000000pt" height="50.000000pt" viewBox="0 0 50.000000 50.000000"  preserveAspectRatio="xMidYMid meet">  <g transform="translate(0.000000,50.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"> <path d="M17 482 c-16 -18 -16 -21 5 -60 14 -25 30 -42 41 -42 9 0 45 -27 80 -61 45 -44 62 -68 62 -87 0 -18 8 -30 24 -38 13 -7 30 -25 36 -41 18 -43 141 -153 170 -153 32 0 65 33 65 65 0 29 -110 152 -153 170 -16 6 -34 23 -41 36 -8 16 -20 24 -38 24 -20 0 -43 17 -87 64 -34 34 -61 71 -61 80 0 10 -16 26 -37 36 -21 11 -41 21 -44 22 -3 2 -13 -5 -22 -15z m74 -48 c0 -5 33 -43 75 -85 41 -41 71 -78 67 -82 -4 -4 -41 26 -82 67 -42 42 -80 75 -85 75 -12 -1 -46 53 -40 63 7 10 66 -25 65 -38z m201 -176 c2 -14 16 -29 36 -38 36 -17 152 -141 152 -162 0 -19 -20 -38 -39 -38 -24 1 -142 113 -160 152 -10 20 -25 34 -39 36 -28 4 -28 19 0 49 27 29 46 29 50 1z"/> <path d="M307 193 c-3 -5 22 -38 57 -72 35 -35 66 -59 69 -54 3 5 -22 38 -57 72 -35 35 -66 59 -69 54z"/> <path d="M334 489 c-16 -5 -41 -20 -53 -33 -20 -21 -23 -33 -18 -66 3 -22 1 -43 -4 -46 -5 -3 -9 -12 -9 -21 0 -13 5 -12 25 7 18 17 22 27 14 36 -20 24 -6 67 30 91 46 31 72 31 43 0 -30 -32 -28 -48 11 -85 39 -38 53 -39 85 -9 l24 22 -7 -25 c-20 -64 -62 -93 -105 -70 -16 9 -25 9 -36 -1 -20 -17 -12 -21 46 -26 43 -3 53 0 74 20 28 28 52 97 42 123 -6 15 -11 13 -41 -16 l-35 -34 -32 32 -32 32 32 33 c44 45 24 59 -54 36z"/> <path d="M150 225 c-15 -15 -34 -25 -52 -25 -86 0 -127 -103 -66 -167 60 -64 167 -22 172 66 1 16 10 39 20 50 15 17 16 21 4 21 -25 0 -48 -35 -48 -73 0 -38 -35 -77 -71 -77 -48 0 -89 41 -89 91 0 32 44 69 83 69 23 0 41 8 60 28 15 15 27 31 27 35 0 14 -17 6 -40 -18z"/> <path d="M78 153 c-22 -5 -35 -50 -21 -71 28 -46 87 -40 98 9 11 50 -22 77 -77 62z m50 -26 c6 -7 9 -23 5 -36 -4 -17 -12 -21 -32 -19 -32 4 -41 36 -15 55 22 16 29 16 42 0z"/> </g> </svg>
            </div>
        </div>
        <div class="wrapper">
                                ...
                                <div class="pad-box">
                                    <div class="text">
                                        ...
                                        <div class="description">
                                            ...
                                            @else
                                                {{ \Illuminate\Support\Str::limit($article->description_ar, 100) }}
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <Link href="/articles/{{$article->id}}" class="read">
                                            @lang('buttons.read')
