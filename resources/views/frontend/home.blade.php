                            ...
                            <div class="inner">
                                <div class="front">
                                    <div class="logo">
                                        ...
                                        @else
                                            <img src="{{ asset('storage/' . 'images/services/logo/default.png') }}"
                                                alt="">
                                        @endif
                                    </div>
                        ...
                        <div class="swiper-wrapper">
                            @foreach ($insurances as $insurance)
                                <div class="box swiper-slide">
                                    ...
                                    @else
                                        <img src="{{ asset('storage/' . 'images/insurances/logos/default.png') }}"
                                            alt="">
                                    @endif
                                </div>
                            @endforeach
                                    ...
                                    @if (Session::get('locale') == 'en')
                                        @if (Storage::exists('public/' . $article->image))
                                            <img src="{{ asset('storage/' . $article->image) }}" alt="image"
                                                class="img">
                                        @else
                                            <img src="{{ asset('storage/' . 'images/articles/thumbnails/default.png') }}"
                                                alt="">
                                        @endif
                                    @else
                                        @if (Storage::exists('public/' . $article->image_ar))
                                            <img src="{{ asset('storage/' . $article->image_ar) }}" alt="image"
                                                class="img">
                                        @else
                                            <img src="{{ asset('storage/' . 'images/articles/thumbnails/default.png') }}"
                                                alt="">
