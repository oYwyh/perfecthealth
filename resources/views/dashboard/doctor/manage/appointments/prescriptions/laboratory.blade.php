<x-doctor.layout>
    <x-doctor.content class="bg">
        ...
        <div class="wrapper prescription">
            <div class="links">
                <Link href="{{route('doctor.manage.appointments.back')}}" method="POST" class="back">
                    @lang('buttons.back')
                </Link>
                <div class="next" id="saveBtn" data-redirect-url="{{ route('doctor.manage.appointments.radiology') }}">
                    @lang('buttons.next')
                </div>
            </div>
                @php
                ...
                @endphp
                @if(null != $app['radiology'])
                    <x-splade-form method="GET" id="redirect-form"  :action="route('doctor.manage.appointments.radiology')">
                        <x-splade-submit id="redirect-btn" />
                    </x-splade-form>
                @elseif(null != $app['medicine'])
                ...
                @endif
                <div class="parent" id="lab-parent">
        ...
        <prescription type="Lab"></prescription>
</x-doctor.layout>
