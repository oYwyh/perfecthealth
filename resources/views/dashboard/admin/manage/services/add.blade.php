<x-admin.layout>
    <x-admin.content class="bg">
        <div class="title">@lang('titles.create') @lang('titles.service')</div>
            <x-splade-form action="{{Route('admin.manage.services.translate')}}" method="POST" id="form" autocomplete="off">
                <div class="group">
