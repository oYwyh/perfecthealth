    ...
    <x-admin.content class="bg">
        <div class="title">Edit Doctor</div>
            <x-splade-form :default="$doctor" :action="Route('admin.manage.doctors.update',['id'=>$id])" method="POST" autocomplete="off">
                <div class="row-group">
                    <x-splade-input class="input" label="" name="name" value="{{ old('Name') }}"/>
                ...
                <div class="row-group">
                    <x-splade-select name="specialty" placeholder="{{$doctor->specialty}}" class="input" label="Speicalty" choices :options="$specialties">
                    </x-splade-select>
