<x-admin.layout>
    <x-admin.content class="bg">
        <div class="title">@lang('auth.register') @lang('titles.receptionist')</div>
            <x-splade-form :action="Route('admin.manage.receptionists.register')" method="POST" autocomplete="off">
                <div class="row-group">
