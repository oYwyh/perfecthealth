<x-admin.layout>
    <x-admin.content class="bg">
        <div class="title">@lang('buttons.add') @lang('titles.insurance')</div>
            <x-splade-form action="{{Route('admin.manage.insurances.create')}}" method="POST" id="form" autocomplete="off">
                <div class="group">
