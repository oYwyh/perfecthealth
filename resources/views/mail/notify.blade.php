...
<head>
    ...
    <title>Dr/ Waleed Haikal website notification</title>
        ...
        <tr>
            <td style="text-align: center;">
                <table style="width: 100%;">
                    <tr>
                        <td style="font-size: 25px; text-align: center">Notification</td>
                    </tr>
                </table>
                <table style="margin-top: 1rem; padding:2rem 0; line-height: 2; width: 100%; background: white;">
                    <tr>
                        <td style="text-align: center; font-size:25px; font-weight: bold;">{{$data['title']}}</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; font-size:22px;">{{$data['type']}}</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; font-size:20px;">{{$data['description']}}</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; font-size: 18px; margin-top:2rem;">{!! nl2br($data['content']) !!}</td>
                    </tr>
                </table>
