...
<head>
    ...
    <title>@lang('auth.email') @lang('auth.verification') @lang('auth.code')</title>
        ...
        <tr>
            <td style="text-align: center;">
                <table style="width: 100%;">
                    <tr>
                        <td style="font-size: 25px; text-align: center">@lang('auth.verification') @lang('auth.code')</td>
                    </tr>
                </table>
                <table style="margin-top: 1rem; width: 100%; background: white;">
                    <tr>
                        <td style="text-align: center; font-size:25px;">@lang('auth.verify_link')</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; font-size: 37px; letter-spacing: 0.7em;">{{$data['code']}}</td>
                    </tr>
                </table>
