...
<template>
    <!-- small -->
    <div class="flex flex-col items-center w-16 h-full overflow-hidden text-gray-700 bg-gray-100 rounded" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
    ...
    <!-- big -->
    <!-- <div class="flex flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-gray-100 rounded" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
